...
class MapsNotificacionG extends StatefulWidget {
  static const routeName = 'maps_gerente';

  @override
  _MapsNotificacionGState createState() => _MapsNotificacionGState();
}

class _MapsNotificacionGState extends State<MapsNotificacionG>
  ...
  _buscarPuntosVentas({@required int zona, @required int edicion}) async {
    isSelectedEdicion = true;
    dynamic estado = await _mapsController
        .billetePuntoVentaPorEdicionNotificacion(edicion: edicion, zona: zona);
        ...
        if (billetePuntoVenta.puntoVenta.geolocalizacion.latitud != null &&
          ...
          listaMarkers.add(Marker(
              infoWindow: InfoWindow(
                  title: Util.checkString(_zonaNombre),
  ...
  Widget build(BuildContext context) {
    ...
    _zonaNombre = arguments['zona_nombre'];
    buildContext = context;
    _buscarPuntosVentas(
        edicion: Util.checkInteger(arguments['edicion']),
        zona: Util.checkInteger(arguments['zona']));
    return Scaffold(
      body: SafeArea(
        child: Stack(
          children: [
