...
class RecogerScallfold extends StatefulWidget {
  final BilletePuntoVenta billetePuntoVenta;
  const RecogerScallfold({Key key, @required this.billetePuntoVenta})
      : super(key: key);
  @override
  _RecogerScallfoldState createState() => _RecogerScallfoldState();
}

class _RecogerScallfoldState extends State<RecogerScallfold>
  ...
  bool _checkBoxValueInicioRecojo = false, _checkBoxValueFinRecojo = false;
  ...
  _init() {
    setState(() {
      ...
      _fechaFinRecojo = widget.billetePuntoVenta.fechaIFinRecojo;
      _fechaInicioRecojo = widget.billetePuntoVenta.fechaInicioRecojo;
      _checkBoxValueFinRecojo = _fechaFinRecojo == "" ? false : true;
      _checkBoxValueInicioRecojo = _fechaInicioRecojo == "" ? false : true;
  ...
  BilletePuntoVenta _validarCampos() {
    ...
    if (isValid) {
      BilletePuntoVenta billetePuntoVenta = widget.billetePuntoVenta.copyWith(
        ...
        fechaIFinRecojo: _fechaFinRecojo,
        fechaInicioRecojo: _fechaInicioRecojo,
  ...
  _inicioRecojo({bool estado}) {
    if (!estado) {
      setState(() {
        _checkBoxValueInicioRecojo = estado;
        _fechaInicioRecojo = "";
        _checkBoxValueFinRecojo = false;
        _fechaFinRecojo = "";
      });
    } else {
      setState(() {
        _checkBoxValueInicioRecojo = estado;
        _fechaInicioRecojo = Utilidades.formatFecha(dateTime: DateTime.now());
      });
    }
  }

  _finRecojo({bool estado}) {
    if (!estado) {
      _checkBoxValueFinRecojo = estado;
      setState(() {
        _fechaFinRecojo = "";
      });
    } else {
      setState(() {
        _checkBoxValueFinRecojo = estado;
        _fechaFinRecojo = Utilidades.formatFecha(dateTime: DateTime.now());
      });
    }
  }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTile(
                            onTap: () {
                              if (_fechaInicioRecojo != "") {
                                DatePicker.showDateTimePicker(context,
                                    currentTime: Utilidades.formatDateTime(
                                        fecha: _fechaInicioRecojo),
                            ...
                            title: Text("Fecha inicio recojo"),
                            subtitle: Text(_fechaInicioRecojo),
                            trailing: Checkbox(
                                value: _checkBoxValueInicioRecojo,
                                activeColor: Colors.green,
                                onChanged: (bool estado) {
                                  _inicioRecojo(estado: estado);
                                }),
                          ),
                          ListTile(
                            onTap: () {
                            ...
                            title: Text("Fecha llegada recojo"),
                            subtitle: Text(_fechaFinRecojo),
                            trailing: Checkbox(
                                value: _checkBoxValueFinRecojo,
                                activeColor: Colors.green,
                                onChanged: (bool estado) {
                                  _finRecojo(estado: estado);
                                }),
                          ),
                          ListTile(
                            trailing: IconButton(
