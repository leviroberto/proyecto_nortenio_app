...
import 'package:proyect_nortenio_app/modules/motorizado/tab/mapa/widgets/item_detalle_card.dart';
...
class MapsTabM extends StatefulWidget {
  @override
  _MapsTabMState createState() => _MapsTabMState();
}

class _MapsTabMState extends State<MapsTabM>
  ...
  MapsControllerM _mapsController = Get.find();
  ...
  _buscarPuntosVentas() async {
    ...
    dynamic estado =
        await _mapsController.billetePuntoVentaPorEdicion(edicion: edicion);
        ...
        if (billetePuntoVenta.puntoVenta.geolocalizacion.latitud != null &&
          ...
          listaMarkers.add(Marker(
              infoWindow: InfoWindow(
                  title: Util.checkString(
                      _mapsController.zonaSeleccionado.value.zona),
