...
class _BilletePuntoVentaPorEdicionState
  ...
  Widget build(BuildContext context) {
    _billetePuntoVentaController = Get.put(BilletePuntoVentaControllerD());
    return Scaffold(
              ...
              child: SmartRefresher(
                  ...
                  child: Obx(() {
                    if (_billetePuntoVentaController
                            .listaBilletesPuntoVenta.length >
                        0) {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          if (widget.edicion.estado == 1) {
            _billetePuntoVentaController.goToAgregar();
          }
        },
      ),
    );
  ...
  List<Widget> recorrerDistribuidores(BilletePuntoVentaControllerD state) {
    ...
    for (int i = 0; i < state.listaBilletesPuntoVenta.length; i++) {
      ...
      listaWidget.add(ItemCard(
        ...
        onTapEliminar: () {
          _confirmarEliminar(context: context, id: billetePuntoVenta.id);
        },
      ));
    }
    return listaWidget;
  ...
  _confirmarEliminar({BuildContext context, int id}) async {
    ...
    print("isOk $isOk");
    if (isOk) {
      _billetePuntoVentaController.eliminar(id: id);
    }
  }
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ItemCard(
                ...
                onTapEliminar: () {
                  _confirmarEliminar(
                      context: context, id: billetePuntoVenta.id);
                },
              );
            },
          );
