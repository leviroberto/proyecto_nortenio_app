...
class GeolocalizacionEditar extends StatefulWidget {
  const GeolocalizacionEditar({
    Key key,
  }) : super(key: key);
  @override
  _GeolocalizacionEditarState createState() => _GeolocalizacionEditarState();
}

class _GeolocalizacionEditarState extends State<GeolocalizacionEditar> {
